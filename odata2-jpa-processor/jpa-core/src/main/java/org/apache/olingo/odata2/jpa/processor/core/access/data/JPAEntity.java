...
public class JPAEntity {
    ...
    public JPAEntity(final EdmEntityType oDataEntityType, final EdmEntitySet oDataEntitySet, final ODataJPAContext context) {
        ...
        onJPAWriteContent = oDataJPAContext.getODataContext()
                                           .getServiceFactory()
    ...
    public void create(final ODataEntry oDataEntry) throws ODataJPARuntimeException {
        ...
        try {
            ...
            if (oDataEntry.getProperties()
                ...
                for (String navigationPropertyName : oDataEntityType.getNavigationPropertyNames()) {
                    EdmNavigationProperty navProperty = (EdmNavigationProperty) oDataEntityType.getProperty(navigationPropertyName);
                    if (relatedJPAEntityMap != null && relatedJPAEntityMap.containsKey(navigationPropertyName)) {
                        oDataEntry.getProperties()
                                  .get(navigationPropertyName);
                        JPALink.linkJPAEntities(relatedJPAEntityMap.get(navigationPropertyName), jpaEntity, navProperty);
                        continue;
                    }
                    ...
                    if (parentJPAEntity != null && navProperty.getRelationship()
                                                              .equals(getViaNavigationProperty().getRelationship())) {
                    ...
                    } else if (!entryMetadata.getAssociationUris(navigationPropertyName)
                                             .isEmpty()) {
        ...
        } catch (EdmException | ODataJPAModelException e) {
    ...
    protected void setComplexProperty(Method accessModifier, final Object jpaEntity, final EdmStructuralType edmComplexType,
            ...
            ODataJPARuntimeException, NoSuchMethodException, SecurityException, SQLException {
    ...
    protected void setEmbeddableKeyProperty(final HashMap<String, String> embeddableKeys, final List<EdmProperty> oDataEntryKeyProperties,
        ...
        for (EdmProperty edmProperty : oDataEntryKeyProperties) {
            if (!oDataEntryProperties.containsKey(edmProperty.getName())) {
                continue;
            }
    ...
    protected void setComplexProperty(Method accessModifier, final Object jpaEntity, final EdmStructuralType edmComplexType,
        ...
        Object embeddableObject = mapping.getJPAType()
                                         .newInstance();
        ...
        for (String edmPropertyName : edmComplexType.getPropertyNames()) {
            if (propertyValue != null) {
                ...
                if (type.getKind()
                        .toString()
                        .equals(EdmTypeKind.COMPLEX.toString())) {
                            ...
                            : edmProperty.getFacets()
                                         .isNullable() == null ? true
                                                 : edmProperty.getFacets()
                                                              .isNullable();
                    if (propertyName != null) {
                        setProperty(accessModifier, embeddableObject, propertyValue.get(edmPropertyName), simpleType, isNullable);
                    } else {
                        setProperty(accessModifier, embeddableObject, propertyValue.get(edmPropertyName), simpleType, isNullable);
                    }
                }
            ...
            if (type != null && type.getDefaultType()
                ...
                if (parameterType.equals(String.class)) {
                    ...
                    Character[] characters =
                            entityPropertyValue != null ? JPAEntityParser.toCharacterArray((String) entityPropertyValue) : null;
                    ...
                    Enum e = entityPropertyValue != null ? Enum.valueOf((Class<Enum>) parameterType, (String) entityPropertyValue) : null;
                ...
                if (onJPAWriteContent == null) {
                    throw ODataJPARuntimeException.throwException(ODataJPARuntimeException.ERROR_JPA_BLOB_NULL, null);
                }
                method.invoke(entity, entityPropertyValue != null ? onJPAWriteContent.getJPABlob((byte[]) entityPropertyValue) : null);
            } else if (parameterType.equals(Clob.class)) {
                if (onJPAWriteContent == null) {
                    throw ODataJPARuntimeException.throwException(ODataJPARuntimeException.ERROR_JPA_CLOB_NULL, null);
                }
                method.invoke(entity,
                        entityPropertyValue != null ? onJPAWriteContent.getJPAClob(((String) entityPropertyValue).toCharArray()) : null);
                ...
                java.sql.Date d =
                        entityPropertyValue != null ? new java.sql.Date(((Calendar) entityPropertyValue).getTimeInMillis()) : null;
                method.invoke(entity, d);
            } else if (parameterType.equals(java.sql.Time.class)) {
                java.sql.Time t =
                        entityPropertyValue != null ? new java.sql.Time(((Calendar) entityPropertyValue).getTimeInMillis()) : null;
                method.invoke(entity, t);
            } else if (parameterType.equals(byte.class)) {
                byte b = entityPropertyValue != null ? Byte.parseByte(entityPropertyValue.toString()) : 0;
