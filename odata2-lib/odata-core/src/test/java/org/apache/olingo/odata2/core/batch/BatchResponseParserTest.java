...
public class BatchResponseParserTest {
    ...
    public void testSimpleBatchResponse() throws BatchException {
        String getResponse = "--batch_123" + CRLF + "Content-Type: application/http" + CRLF + "Content-Transfer-Encoding: binary" + CRLF
                + "Content-ID: 1" + CRLF + CRLF + "HTTP/1.1 200 OK" + CRLF + "DataServiceVersion: 2.0" + CRLF
                + "Content-Type: text/plain;charset=utf-8" + CRLF + "Content-length: 22" + CRLF + CRLF + "Frederic Fall MODIFIED" + CRLF
                + "--batch_123--";
        ...
        for (BatchSingleResponse response : responses) {
            ...
            assertEquals("text/plain;charset=utf-8", response.getHeaders()
                                                             .get(HttpHeaders.CONTENT_TYPE));
            assertEquals("22", response.getHeaders()
                                       .get("Content-length"));
    ...
    public void testSimpleBatchResponseWithLinebreak() throws BatchException {
        String getResponse = "--batch_123" + CRLF + "Content-Type: application/http" + CRLF + "Content-Transfer-Encoding: binary" + CRLF
                + "Content-ID: 1" + CRLF + CRLF + "HTTP/1.1 200 OK" + CRLF + "DataServiceVersion: 2.0" + CRLF
                + "Content-Type: text/plain;charset=utf-8" + CRLF + "Content-length: 24" + CRLF + CRLF + "Frederic Fall MODIFIED" + CRLF
                + CRLF + "--batch_123--";
        ...
        for (BatchSingleResponse response : responses) {
            ...
            assertEquals("text/plain;charset=utf-8", response.getHeaders()
                                                             .get(HttpHeaders.CONTENT_TYPE));
            assertEquals("24", response.getHeaders()
                                       .get("Content-length"));
            assertEquals("1", response.getContentId());
    ...
    public void testNoContentResponse() throws Exception {
        ...
        for (BatchSingleResponse response : responses) {
            ...
            assertEquals("text/html", response.getHeaders()
                                              .get(HttpHeaders.CONTENT_TYPE));
        }
    }
    ...
    public void testBatchResponse() throws BatchException, IOException {
        ...
        InputStream in = BatchResponseParserTest.class.getResourceAsStream(fileName);
        if (in == null) {
            throw new IOException("Requested file '" + fileName + "' was not found.");
        }
        BatchParser parser = new BatchParser("multipart/mixed;boundary=batch_123", true);
        List<BatchSingleResponse> responses = parser.parseBatchResponse(StringHelper.toStream(in)
                                                                                    .asStreamWithLineSeparation("\r\n"));
        for (BatchSingleResponse response : responses) {
    ...
    public void testResponseToChangeSet() throws BatchException {
        String putResponse = "--batch_123" + CRLF + "Content-Type: " + HttpContentType.MULTIPART_MIXED + ";boundary=changeset_12ks93js84d"
                + CRLF + CRLF + "--changeset_12ks93js84d" + CRLF + "Content-Type: application/http" + CRLF
                + "Content-Transfer-Encoding: binary" + CRLF + "Content-ID: 1" + CRLF + CRLF + "HTTP/1.1 204 No Content" + CRLF
                + "DataServiceVersion: 2.0" + CRLF + CRLF + CRLF + "--changeset_12ks93js84d--" + CRLF + CRLF + "--batch_123--";
    ...
    public void testResponseChangeSetBodyWithoutCRLF() throws BatchException {
        String putResponse = "--batch_123" + CRLF + "Content-Type: " + HttpContentType.MULTIPART_MIXED + ";boundary=changeset_12ks93js84d"
                + CRLF + CRLF + "--changeset_12ks93js84d" + CRLF + "Content-Type: application/http" + CRLF
                + "Content-Transfer-Encoding: binary" + CRLF + "Content-ID: 1" + CRLF + CRLF + "HTTP/1.1 200 Ok" + CRLF
                + "DataServiceVersion: 2.0" + CRLF + "Content-Length: 19" + CRLF + CRLF + "TestBodyWithoutCRLF" + CRLF
                + "--changeset_12ks93js84d--" + CRLF + CRLF + "--batch_123--";
    ...
    public void testResponseChangeSetBodyWithCRLF() throws BatchException {
        String putResponse = "--batch_123" + CRLF + "Content-Type: " + HttpContentType.MULTIPART_MIXED + ";boundary=changeset_12ks93js84d"
                + CRLF + CRLF + "--changeset_12ks93js84d" + CRLF + "Content-Type: application/http" + CRLF
                + "Content-Transfer-Encoding: binary" + CRLF + "Content-ID: 1" + CRLF + CRLF + "HTTP/1.1 200 Ok" + CRLF
                + "DataServiceVersion: 2.0" + CRLF + "Content-Length: 18" + CRLF + CRLF + "TestBodyWithCRLF" + CRLF + CRLF
                + "--changeset_12ks93js84d--" + CRLF + CRLF + "--batch_123--";
    ...
    public void testResponseToChangeSetNoContentButContentLength() throws BatchException {
        String putResponse =
                "--batch_123" + CRLF + "Content-Type: " + HttpContentType.MULTIPART_MIXED + ";boundary=changeset_12ks93js84d" + CRLF + CRLF
                        + "--changeset_12ks93js84d" + CRLF + "Content-Type: application/http" + CRLF + "Content-Transfer-Encoding: binary"
                        + CRLF + "Content-ID: 1" + CRLF + CRLF + "HTTP/1.1 204 No Content" + CRLF + "Content-Length: 0" + CRLF
                        + "DataServiceVersion: 2.0" + CRLF + CRLF + CRLF + "--changeset_12ks93js84d--" + CRLF + CRLF + "--batch_123--";
    ...
    public void testInvalidMimeHeader() throws BatchException {
        String putResponse = "--batch_123" + CRLF + "Content-Type: " + HttpContentType.MULTIPART_MIXED + ";boundary=changeset_12ks93js84d"
                ...
                + CRLF + "HTTP/1.1 No Content" + CRLF + "DataServiceVersion: 2.0" + CRLF + CRLF + CRLF + "--changeset_12ks93js84d--" + CRLF
                + CRLF + "--batch_123--";
    ...
    public void testMissingMimeHeader() throws BatchException {
        String putResponse = "--batch_123" + CRLF + "Content-Type: " + HttpContentType.MULTIPART_MIXED + ";boundary=changeset_12ks93js84d"
                + CRLF + CRLF + "--changeset_12ks93js84d" + CRLF + CRLF + "HTTP/1.1 No Content" + CRLF + "DataServiceVersion: 2.0" + CRLF
                + CRLF + CRLF + "--changeset_12ks93js84d--" + CRLF + CRLF + "--batch_123--";
    ...
    public void testInvalidContentType() throws BatchException {
        String putResponse = "--batch_123" + CRLF + "Content-Type: " + HttpContentType.MULTIPART_MIXED + CRLF // Missing boundary parameter
                + CRLF + "--changeset_12ks93js84d" + CRLF + "Content-Type: application/http" + CRLF + "Content-Transfer-Encoding: binary"
                + CRLF + CRLF + "HTTP/1.1 No Content" + CRLF + "DataServiceVersion: 2.0" + CRLF + CRLF + CRLF + "--changeset_12ks93js84d--"
                + CRLF + CRLF + "--batch_123--";
    ...
    public void testInvalidStatusLine() throws BatchException {
        String putResponse = "--batch_123" + CRLF + "Content-Type: " + HttpContentType.MULTIPART_MIXED + ";boundary=changeset_12ks93js84d"
                + CRLF + CRLF + "--changeset_12ks93js84d" + CRLF + "Content-Type: application/http" + CRLF
                + "Content-Transfer-Encoding: binary" + CRLF + CRLF + "HTTP/1.1 No Content" + CRLF + "DataServiceVersion: 2.0" + CRLF + CRLF
                + CRLF + "--changeset_12ks93js84d--" + CRLF + CRLF + "--batch_123--";
    ...
    public void testMissingCloseDelimiter() throws BatchException {
        String putResponse = "--batch_123" + CRLF + "Content-Type: " + HttpContentType.MULTIPART_MIXED + ";boundary=changeset_12ks93js84d"
                + CRLF + CRLF + "--changeset_12ks93js84d" + CRLF + "Content-Type: application/http" + CRLF
                + "Content-Transfer-Encoding: binary" + CRLF + CRLF + "HTTP/1.1 204 No Content" + CRLF + "DataServiceVersion: 2.0" + CRLF
                + CRLF + CRLF + "--changeset_12ks93js84d--" + CRLF + CRLF;
    ...
    public void tooBigContentLegthDoesNotResultInException() throws BatchException {
        String getResponse = "--batch_123" + CRLF + "Content-Type: application/http" + CRLF + "Content-Transfer-Encoding: binary" + CRLF
                + "Content-ID: 1" + CRLF + CRLF + "HTTP/1.1 200 OK" + CRLF + "DataServiceVersion: 2.0" + CRLF
                + "Content-Type: text/plain;charset=utf-8" + CRLF + "Content-Length: 100" + CRLF + CRLF + "Frederic Fall" + CRLF
                + "--batch_123--";

        InputStream in = new ByteArrayInputStream(getResponse.getBytes());
        List<BatchSingleResponse> batchResponse = EntityProvider.parseBatchResponse(in, "multipart/mixed;boundary=batch_123");
    ...
    public void testInvalidBoundary() throws BatchException {
        String getResponse = "--batch_321" + CRLF + "Content-Type: application/http" + CRLF + "Content-Transfer-Encoding: binary" + CRLF
                + "Content-ID: 1" + CRLF + CRLF + "HTTP/1.1 200 OK" + CRLF + "DataServiceVersion: 2.0" + CRLF
                + "Content-Type: text/plain;charset=utf-8" + CRLF + CRLF + "Frederic Fall" + CRLF + CRLF + "--batch_123--";
    ...
    public void boundaryInBodyMustBeIgnored() throws BatchException {
        String getResponse = "--batch_123" + CRLF + "Content-Type: application/http" + CRLF + "Content-Transfer-Encoding: binary" + CRLF
                + CRLF + "HTTP/1.1 200 OK" + CRLF + "Content-Type: text/plain;charset=utf-8" + CRLF + "Content-Length: 13" + CRLF + CRLF
                + "Frederic Fall" + CRLF + CRLF + "batch_123" + CRLF + "Content-Type: application/http" + CRLF
                + "Content-Transfer-Encoding: binary" + CRLF + CRLF + "HTTP/1.1 200 OK" + CRLF + "Content-Type: text/plain;charset=utf-8"
                + CRLF + CRLF + "Walter Winter" + CRLF + CRLF + "--batch_123--";
        InputStream in = new ByteArrayInputStream(getResponse.getBytes());
        List<BatchSingleResponse> batchResponse = EntityProvider.parseBatchResponse(in, "multipart/mixed;boundary=batch_123");
        BatchSingleResponse response = batchResponse.get(0);
    ...
    public void parseWithAdditionalLineEndingAtTheEnd() throws Exception {
        ...
        BatchSingleResponse response = EntityProvider.parseBatchResponse(stream, "multipart/mixed;boundary=batch_123")
                                                     .get(0);
        assertEquals("This is the body we need to parse. The trailing line ending is part of the body." + CRLF, response.getBody());
    ...
    public void parseWithWindowsLineEndingsInBody() throws Exception {
        ...
        stream = StringHelper.toStream(stream)
                             .asStreamWithLineSeparation(CRLF);
        BatchSingleResponse response = EntityProvider.parseBatchResponse(stream, "multipart/mixed;boundary=batch_123")
                                                     .get(0);
        String body = "This is the body we need to parse. The line spaces in the body " + CRLF + CRLF + CRLF + "are " + CRLF + CRLF
    ...
    public void parseWithUnixLineEndingsInBody() throws Exception {
        String body = "This is the body we need to parse. The line spaces in the body " + LF + LF + LF + "are " + LF + LF
                + "part of the body and must not be ignored or filtered.";
        String responseString = "--batch_123" + CRLF + "Content-Type: application/http" + CRLF + "Content-Length: 234" + CRLF
                + "content-transfer-encoding: binary" + CRLF + CRLF + "HTTP/1.1 500 Internal Server Error" + CRLF
                + "Content-Type: application/xml;charset=utf-8" + CRLF + "Content-Length: 125" + CRLF + CRLF + body + CRLF
                + "--batch_123--";
