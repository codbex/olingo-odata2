...
public class ExpressionParserException extends ODataBadRequestException {
  ...
  /** The Constant TOKEN_UNDETERMINATED_STRING. */
  ...
  /** The Constant INVALID_TRAILING_TOKEN_DETECTED_AFTER_PARSING. */
  ...
  /** The Constant EXPRESSION_EXPECTED_AFTER_POS. */
  // parsing
  ...
  /** The Constant COMMA_OR_END_EXPECTED_AT_POS. */
  ...
  /** The Constant EXPRESSION_EXPECTED_AT_POS. */
  ...
  /** The Constant MISSING_CLOSING_PARENTHESIS. */
  ...
  /** The Constant COMMA_OR_CLOSING_PARENTHESIS_EXPECTED_AFTER_POS. */
  ...
  /** The Constant METHOD_WRONG_ARG_BETWEEN. */
  ...
  /** The Constant METHOD_WRONG_ARG_X_OR_MORE. */
  ...
  /** The Constant METHOD_WRONG_ARG_X_OR_LESS. */
  ...
  /** The Constant METHOD_WRONG_INPUT_TYPE. */
  ...
  /** The Constant LEFT_SIDE_NOT_STRUCTURAL_TYPE. */
  ...
  /** The Constant LEFT_SIDE_NOT_A_PROPERTY. */
  ...
  /** The Constant PROPERTY_NAME_NOT_FOUND_IN_TYPE. */
  ...
  /** The Constant INVALID_MULTIPLICITY. */
  ...
  /** The Constant INVALID_TYPES_FOR_BINARY_OPERATOR. */
  ...
  /** The Constant INVALID_SORT_ORDER. */
  // orderby
