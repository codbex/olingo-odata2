...
public class XmlPropertyDeserializer {
    ...
    public Map<String, Object> readProperty(final XMLStreamReader reader, final EntityPropertyInfo propertyInfo,
        ...
        final EntityTypeMapping typeMappings = EntityTypeMapping.create(
                readProperties == null ? Collections.<String, Object>emptyMap() : readProperties.getTypeMappings());
        try {
            reader.next();
    ...
    public List<Object> readCollection(XMLStreamReader reader, final EntityPropertyInfo info, final DeserializerProperties properties)
        ...
        final EntityTypeMapping typeMappings = EntityTypeMapping.create(properties == null || !properties.getTypeMappings()
        ...
        try {
            ...
            return result;
        } catch (final XMLStreamException | EdmException e) {
            throw new EntityProviderException(EntityProviderException.EXCEPTION_OCCURRED.addContent(e.getClass()
                                                                                                     .getSimpleName()),
                    e);
        }
        ...
        try {
            ...
            if (TRUE.equals(nullAttribute)) {
                ...
                if (typeAttribute != null) {
                    final String expectedTypeAttributeValue = propertyInfo.getType()
                                                                          .getNamespace()
                            + Edm.DELIMITER + propertyInfo.getType()
                                                          .getName();
                    if (!expectedTypeAttributeValue.equals(typeAttribute)) { // NOSONAR
                        throw new EntityProviderException(
                                EntityProviderException.INVALID_COMPLEX_TYPE.addContent(expectedTypeAttributeValue)
                                                                            .addContent(typeAttribute));
                    }
                }
                ...
                while (reader.hasNext() && !reader.isEndElement()) {
                    ...
                    final Object value =
                            readStartedElement(reader, childName, childProperty, typeMappings.getEntityTypeMapping(name), readProperties);
    ...
    private Object convert(final EntityPropertyInfo property, final String value, Class<?> typeMapping,
        ...
        EdmFacets facets = readProperties == null || readProperties.isValidatingFacets() ? property.getFacets() : null;
        typeMapping = typeMapping == null ? type.getDefaultType() : typeMapping;
        return type.valueOfString(value, EdmLiteralKind.DEFAULT, facets, typeMapping);
    }
}
